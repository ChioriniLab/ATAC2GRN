...
READS=1
EXPERIMENT=/data/pranzatellitj/check_HOMER_stitching/10Ms/experiments/DNase-$ROUND
DATA=/data/pranzatellitj/check_HOMER_stitching/10Ms/datas/DNase-$ROUND.fastq
