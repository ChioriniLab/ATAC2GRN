...
READS=1
EXPERIMENT=/data/pranzatellitj/check_HOMER_stitching/experiments_DNase/$ENCSR
DATA=/data/pranzatellitj/check_HOMER_stitching/titrated_data_DNase/$ENCSR.fastq
...
if [[ $READS == 1 ]]
    ...
    # These files are passed to bowtie2 to be aligned to the given genome index.
    bowtie2 -x $GENOME/Bowtie2Index/genome -p 32 -t -q -1 $EXPERIMENT/P1.fastq -2 $EXPERIMENT/P2.fastq -S $EXPERIMENT/bowtie2.sam
