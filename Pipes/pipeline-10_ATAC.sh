...
READS=1
EXPERIMENT=/data/pranzatellitj/check_HOMER_stitching/10Ms/experiments/ATAC-$ROUND
DATA=/data/pranzatellitj/check_HOMER_stitching/10Ms/datas/ATAC-$ROUND.fastq
